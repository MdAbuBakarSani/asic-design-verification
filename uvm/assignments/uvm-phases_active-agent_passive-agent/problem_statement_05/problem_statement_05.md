...
`include "uvm_macros.svh"   // Includes UVM macros like `uvm_info and factory utilities
import uvm_pkg::*; 
...
// storage until check_phase happens 
...
`uvm_info ("Scoreboard", $sformatf("Received transaction in run phase: %s", 
tr.covert2string()), UVM_LOW) 
